...
namespace SWPharmacy.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quantidade,ValorTotal,TipoPagamento")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quantidade,ValorTotal,TipoPagamento")] Venda venda)
        {
            if (id != venda.Id)
            {
                return NotFound();
